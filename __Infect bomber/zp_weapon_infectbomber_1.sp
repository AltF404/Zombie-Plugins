...
{
	hCvarHolyRadius   = CreateConVar("zp_weapon_infectbomber_radius", "200.0", "Explosion radius", 0, true, 0.0);
	hCvarHolyDuration = CreateConVar("zp_weapon_infectbomber_duration", "2.0", "Ignite duration", 0, true, 0.0);
	hCvarHolyTrail    = CreateConVar("zp_weapon_infectbomber_trail", "0", "Attach trail to the projectile?", 0, true, 0.0, true, 1.0);
	hCvarHolyEffect   = CreateConVar("zp_weapon_infectbomber_effect", "explosion_hegrenade_dirt", "Particle effect for the explosion (''-default)");
		
	AutoExecConfig(true, "zp_weapon_infectbomber", "sourcemod/zombieplague");
}
...
{
	gWeapon = ZP_GetWeaponNameID("infect bomber");
