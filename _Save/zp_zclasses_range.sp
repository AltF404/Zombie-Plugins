...
{ 
	hCvarSkillRadius = CreateConVar("zp_zclass_psyhe_radius", "250.0", "Wave radius", 0, true, 0.0);
	//hCvarSkillDamage = CreateConVar("zp_zclass_psyhe_damage", "1.0", "Damage amount", 0, true, 0.0);
	hCvarSkillEffect = CreateConVar("zp_zclass_psyhe_effect", "hell_end", "Particle effect for the skill (''-off)");
	
	AutoExecConfig(true, "zp_zclass_psyhe", "sourcemod/zombieplague");
}
