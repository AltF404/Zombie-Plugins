...
{
	hCvarSkillSpeed  = CreateConVar("zp_zclass_police_speed", "1.4", "Speed multiplier", 0, true, 0.0);
	hCvarSkillEffect = CreateConVar("zp_zclass_police_effect", "sila_trail_apalaal", "Particle effect for the skill (''-default)");
	
	AutoExecConfig(true, "zp_zclass_police", "sourcemod/zombieplague");
}
...
{
	gZombie = ZP_GetClassNameID("police");
