...
{
	hCvarSkillReduction = CreateConVar("zp_zclass_nanosuit2_reduction", "0.3", "Damage reduction multiplier", 0, true, 0.0, true, 1.0);
//	hCvarSkillEffect    = CreateConVar("zp_zclass_nanosuit2_effect", "cloud", "Particle effect for the skill (''-default)");

	AutoExecConfig(true, "zp_zclass_nanosuit2", "sourcemod/zombieplague");
}
...
{
	gZombie = ZP_GetClassNameID("nanosuit2");
